...
2. 模拟完整Swiss赛制(5轮，R1固定对阵，R2+完全复刻官方真实Buchholz难度分并加入规避重复交手的递归匹配逻辑，Bo3用于晋级/淘汰局)
...
- **用暴力搜索而非手动**: 搜索空间~3000种组合，模拟已含关联性，直接算最优解

## 赛事记录

| 赛事                 | 日期     | 方案                                           | P(≥5) | 结果 |
| :------------------- | :------- | :--------------------------------------------- | :---: | :--- |
| 2026 Cologne Stage 1 | 06-02~05 | GL+BB 3-0 / B8,HR,TL,LQ,BG,MB 312 / TdU,GG 0-3 | 38.0% | **5分 (达标)** |
